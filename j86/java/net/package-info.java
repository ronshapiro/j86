 ...
 *
 * <p> The j86.java.net package can be roughly divided in two sections:</p>
 * <ul>
 ...
 * </ul>
 * <h2>Addresses</h2>
 * <p>Addresses are used throughout the j86.java.net APIs as either host
 *    identifiers, or socket endpoint identifiers.</p>
 * <p>The {@link j86.java.net.InetAddress} class is the abstraction representing an
 *    IP (Internet Protocol) address.  It has two subclasses:
 * <ul>
 *       <li>{@link j86.java.net.Inet4Address} for IPv4 addresses.</li>
 *       <li>{@link j86.java.net.Inet6Address} for IPv6 addresses.</li>
 * </ul>
 ...
 *    more. While methods like {@link j86.java.net.InetAddress#getByName} are
 ...
 *    the network. The j86.java.net package provides 4 kinds of Sockets:</p>
 * <ul>
 *       <li>{@link j86.java.net.Socket} is a TCP client API, and will typically
 *            be used to {@linkplain j86.java.net.Socket#connect(SocketAddress)
 *            connect} to a remote host.</li>
 *       <li>{@link j86.java.net.ServerSocket} is a TCP server API, and will
 *            typically {@linkplain j86.java.net.ServerSocket#accept accept}
 *            connections from client sockets.</li>
 *       <li>{@link j86.java.net.DatagramSocket} is a UDP endpoint API and is used
 *            to {@linkplain j86.java.net.DatagramSocket#send send} and
 *            {@linkplain j86.java.net.DatagramSocket#receive receive}
 *            {@linkplain j86.java.net.DatagramPacket datagram packets}.</li>
 *       <li>{@link j86.java.net.MulticastSocket} is a subclass of
 ...
 *    {@link j86.java.net.Socket#getInputStream} and
 *    {@link j86.java.net.Socket#getOutputStream} methods.</p>
 * <h2>Interfaces</h2>
 * <p>The {@link j86.java.net.NetworkInterface} class provides APIs to browse and
 ...
 * <p>A number of classes in the j86.java.net package do provide for a much higher
 *    level of abstraction and allow for easy access to resources on the
 *    network. The classes are:
 * <ul>
 *       <li>{@link j86.java.net.URI} is the class representing a
 ...
 *       <li>{@link j86.java.net.URL} is the class representing a
 *            Universal Resource Locator, which is both an older concept for
 *            URIs and a means to access the resources.</li>
 *       <li>{@link j86.java.net.URLConnection} is created from a URL and is the
 ...
 *       <li>{@link j86.java.net.HttpURLConnection} is a subclass of URLConnection
 *            and provides some additional functionalities specific to the
 *            HTTP protocol.</li>
 * </ul>
 * <p>The recommended usage is to use {@link j86.java.net.URI} to identify
 *    resources, then convert it into a {@link j86.java.net.URL} when it is time to
 *    access the resource. From that URL, you can either get the
 *    {@link j86.java.net.URLConnection} for fine control, or get directly the
 *    InputStream.
 ...
 *    class {@link j86.java.net.URLStreamHandler}.</p>
