...
public final class Spliterators {
     ...
     * {@link j86.java.util.Collection#iterator()} as the source of elements, and
     * reporting its {@link j86.java.util.Collection#size()} as its initial size.
     *
     ...
     * <p>An alternative to using this class, that also permits limited
     * parallelism, is to create a spliterator from an iterator
     * (see {@link #spliterator(j86.java.util.PrimitiveIterator.OfInt, long, int)}.
     ...
     *
     * @see #spliterator(j86.java.util.PrimitiveIterator.OfInt, long, int)
     * @since 1.8
     */
     ...
     * <p>An alternative to using this class, that also permits limited
     * parallelism, is to create a spliterator from an iterator
     * (see {@link #spliterator(j86.java.util.PrimitiveIterator.OfLong, long, int)}.
     * Depending on the circumstances using an iterator may be easier or more
     * convenient than extending this class. For example, if there is already an
     * iterator available to use then there is no need to extend this class.
     *
     * @see #spliterator(j86.java.util.PrimitiveIterator.OfLong, long, int)
     * @since 1.8
     */
     ...
     * <p>An alternative to using this class, that also permits limited
     * parallelism, is to create a spliterator from an iterator
     * (see {@link #spliterator(j86.java.util.PrimitiveIterator.OfDouble, long, int)}.
     * Depending on the circumstances using an iterator may be easier or more
     * convenient than extending this class. For example, if there is already an
     * iterator available to use then there is no need to extend this class.
     *
     * @see #spliterator(j86.java.util.PrimitiveIterator.OfDouble, long, int)
     * @since 1.8
     */
    ...
    static class IteratorSpliterator<T> implements Spliterator<T> {
         ...
         * collection's {@link j86.java.util.Collection#iterator()) for traversal,
         * and reporting its {@link j86.java.util.Collection#size()) as its initial
         * size.
         *
         * @param c the collection
