 ...
 * j86.java.util.ResourceBundle.Control}. The <a
 ...
 * no {@link j86.java.util.ResourceBundle.Control} instance can be modified with {@code
 ...
 * Mechanism</a> as installed extensions. Refer to {@link j86.java.util.ServiceLoader}
 * for the extension packaging. Any installed {@code
 * ResourceBundleControlProvider} implementations are loaded using {@link
 * j86.java.util.ServiceLoader} at the {@code ResourceBundle} class loading time.
 *
 * @author Masayoshi Okutsu
 * @since 1.8
 * @see ResourceBundle#getBundle(String, j86.java.util.Locale, ClassLoader, ResourceBundle.Control)
 *      ResourceBundle.getBundle
 * @see j86.java.util.ServiceLoader#loadInstalled(Class)
 */
