 ...
 * classes {@link j86.java.util.stream.Stream}, {@link java.util.stream.IntStream},
 * {@link j86.java.util.stream.LongStream}, and {@link java.util.stream.DoubleStream}
 ...
 *     {@link j86.java.util.stream.Stream#of(Object[])},
 *     {@link j86.java.util.stream.IntStream#range(int, int)}
 *     or {@link j86.java.util.stream.Stream#iterate(Object, UnaryOperator)};</li>
 *     <li>The lines of a file can be obtained from {@link j86.java.io.BufferedReader#lines()};</li>
 *     <li>Streams of file paths can be obtained from methods in {@link j86.java.nio.file.Files};</li>
 ...
 *     {@link j86.java.util.regex.Pattern#splitAsStream(j86.java.lang.CharSequence)},
 *     and {@link j86.java.util.jar.JarFile#stream()}.</li>
 * </ul>
 *
 ...
 * stream-bearing methods such as {@link j86.java.util.stream.IntStream#range(int, int)}
 * produce sequential streams but these streams can be efficiently parallelized by
 * invoking their {@link j86.java.util.stream.BaseStream#parallel()} method.
 ...
 * {@link j86.java.util.stream.BaseStream#sequential()} and
 * {@link j86.java.util.stream.BaseStream#parallel()} operations.  When the terminal
 ...
 * ordered stream unordered, such as {@link j86.java.util.stream.BaseStream#unordered()}.
 ...
 * the stream with {@link j86.java.util.stream.BaseStream#unordered() unordered()} may
 ...
 * {@link j86.java.util.stream.Stream#reduce(j86.java.util.function.BinaryOperator) reduce()}
 * and {@link j86.java.util.stream.Stream#collect(java.util.stream.Collector) collect()},
 * as well as multiple specialized reduction forms such as
 * {@link j86.java.util.stream.IntStream#sum() sum()}, {@link java.util.stream.IntStream#max() max()},
 * or {@link j86.java.util.stream.IntStream#count() count()}.
 *
 ...
 * {@link j86.java.util.stream.Stream#collect(Collector) collect()},
 ...
 * {@link j86.java.util.stream.Collector} to capture all three aspects.  The
 ...
 * composability.  The class {@link j86.java.util.stream.Collectors} contains a
 ...
 * {@link j86.java.util.stream.Collectors#groupingBy(j86.java.util.function.Function, java.util.stream.Collector) groupingBy}:
 *
 * <pre>{@code
 ...
 * {@link j86.java.util.concurrent.ConcurrentHashMap}. In that case, the parallel
 ...
 *
 * <p>A {@link j86.java.util.stream.Collector} that supports concurrent reduction is
 * marked with the {@link j86.java.util.stream.Collector.Characteristics#CONCURRENT}
 ...
 * stream being processed. The {@link j86.java.util.stream.Stream#collect(Collector)}
 * implementation will only perform a concurrent reduction if
 * <ul>
 * <li>The stream is parallel;</li>
 * <li>The collector has the
 * {@link j86.java.util.stream.Collector.Characteristics#CONCURRENT} characteristic,
 * and;</li>
 * <li>Either the stream is unordered, or the collector has the
 * {@link j86.java.util.stream.Collector.Characteristics#UNORDERED} characteristic.
 * </ul>
 * You can ensure the stream is unordered by using the
 * {@link j86.java.util.stream.BaseStream#unordered()} method.  For example:
 * <pre>{@code
 *     Map<Buyer, List<Transaction>> salesByBuyer
 *         = txns.parallelStream()
 *               .unordered()
 ...
 * }</pre>
 * (where {@link j86.java.util.stream.Collectors#groupingByConcurrent} is the
 ...
 *
 * <p>The class {@link j86.java.util.stream.StreamSupport} has a number of
 ...
 * {@link j86.java.util.stream.StreamSupport#stream(Supplier, int, boolean) stream()}.
