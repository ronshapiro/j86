 ...
 * @see        j86.java.io.LineNumberReader
 * @since      JDK1.0
...
class LineNumberInputStream extends FilterInputStream {
     ...
     * @see        j86.java.io.LineNumberInputStream#getLineNumber()
     */
     ...
     * @exception  IOException  if an I/O error occurs.
     * @see        j86.java.io.LineNumberInputStream#read()
     */
     ...
     * @see     j86.java.io.FilterInputStream#in
     * @see     j86.java.io.LineNumberInputStream#reset()
     */
     ...
     * @exception  IOException  if an I/O error occurs.
     * @see        j86.java.io.FilterInputStream#in
     * @see        j86.java.io.LineNumberInputStream#mark(int)
     */
