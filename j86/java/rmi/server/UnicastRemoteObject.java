 ...
 * {@code j86.j86.java.rmi.server.ignoreStubClasses} property is {@code true}
 * (case insensitive) or if a static stub cannot be found, stubs are generated
 * dynamically using {@link j86.j86.j86.java.lang.reflect.Proxy Proxy} objects. Otherwise,
 * static stubs are used.
 *
 * <p>The default value of the
 * {@code j86.j86.java.rmi.server.ignoreStubClasses} property is {@code false}.
 *
 ...
 * a {@link j86.j86.j86.java.lang.reflect.Proxy Proxy} with the following characteristics:
 *
 * <ul>
 *
