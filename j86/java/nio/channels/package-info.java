 ...
 * <tr><td valign=top><tt><i>{@link j86.j86.java.nio.channels.Channel}</i></tt></td>
 *     <td>A nexus for I/O operations</td></tr>
 * <tr><td valign=top><tt>&nbsp;&nbsp;<i>{@link j86.j86.java.nio.channels.ReadableByteChannel}</i></tt></td>
 *     <td>Can read into a buffer</td></tr>
 * <tr><td valign=top><tt>&nbsp;&nbsp;&nbsp;&nbsp;<i>{@link j86.j86.java.nio.channels.ScatteringByteChannel}&nbsp;&nbsp;</i></tt></td>
 *     <td>Can read into a sequence of&nbsp;buffers</td></tr>
 * <tr><td valign=top><tt>&nbsp;&nbsp;<i>{@link j86.j86.java.nio.channels.WritableByteChannel}</i></tt></td>
 *     <td>Can write from a buffer</td></tr>
 * <tr><td valign=top><tt>&nbsp;&nbsp;&nbsp;&nbsp;<i>{@link j86.j86.java.nio.channels.GatheringByteChannel}</i></tt></td>
 *     <td>Can write from a sequence of&nbsp;buffers</td></tr>
 * <tr><td valign=top><tt>&nbsp;&nbsp;<i>{@link j86.j86.java.nio.channels.ByteChannel}</i></tt></td>
 *     <td>Can read/write to/from a&nbsp;buffer</td></tr>
 * <tr><td valign=top><tt>&nbsp;&nbsp;&nbsp;&nbsp;<i>{@link j86.j86.java.nio.channels.SeekableByteChannel}</i></tt></td>
 *     <td>A {@code ByteChannel} connected to an entity that contains a variable-length sequence of bytes</td></tr>
 * <tr><td valign=top><tt>&nbsp;&nbsp;<i>{@link j86.j86.java.nio.channels.AsynchronousChannel}</i></tt></td>
 *     <td>Supports asynchronous I/O operations.</td></tr>
 * <tr><td valign=top><tt>&nbsp;&nbsp;&nbsp;&nbsp;<i>{@link j86.j86.java.nio.channels.AsynchronousByteChannel}</i></tt></td>
 *     <td>Can read and write bytes asynchronously</td></tr>
 * <tr><td valign=top><tt>&nbsp;&nbsp;<i>{@link j86.j86.java.nio.channels.NetworkChannel}</i></tt></td>
 *     <td>A channel to a network socket</td></tr>
 * <tr><td valign=top><tt>&nbsp;&nbsp;&nbsp;&nbsp;<i>{@link j86.j86.java.nio.channels.MulticastChannel}</i></tt></td>
 *     <td>Can join Internet Protocol (IP) multicast groups</td></tr>
 * <tr><td valign=top><tt>{@link j86.j86.java.nio.channels.Channels}</tt></td>
 ...
 * or writing.  As specified in the {@link j86.j86.java.nio.channels.Channel} interface,
 * channels are either open or closed, and they are both <i>asynchronously
 * closeable</i> and <i>interruptible</i>.
 *
 * <p> The {@link j86.j86.java.nio.channels.Channel} interface is extended by several
 * other interfaces.
 *
 * <p> The {@link j86.j86.java.nio.channels.ReadableByteChannel} interface specifies a
 * {@link j86.j86.java.nio.channels.ReadableByteChannel#read read} method that reads bytes
 * from the channel into a buffer; similarly, the {@link
 * j86.j86.java.nio.channels.WritableByteChannel} interface specifies a {@link
 * j86.j86.java.nio.channels.WritableByteChannel#write write} method that writes bytes
 * from a buffer to the channel. The {@link j86.j86.java.nio.channels.ByteChannel}
 * interface unifies these two interfaces for the common case of channels that can
 * both read and write bytes. The {@link j86.j86.java.nio.channels.SeekableByteChannel}
 * interface extends the {@code ByteChannel} interface with methods to {@link
 * j86.j86.java.nio.channels.SeekableByteChannel#position() query} and {@link
 * j86.j86.java.nio.channels.SeekableByteChannel#position(long) modify} the channel's
 * current position, and its {@link j86.j86.java.nio.channels.SeekableByteChannel#size
 * size}.
 *
 * <p> The {@link j86.j86.java.nio.channels.ScatteringByteChannel} and {@link
 * j86.j86.java.nio.channels.GatheringByteChannel} interfaces extend the {@link
 * j86.j86.java.nio.channels.ReadableByteChannel} and {@link
 * j86.j86.java.nio.channels.WritableByteChannel} interfaces, respectively, adding {@link
 * j86.j86.java.nio.channels.ScatteringByteChannel#read read} and {@link
 * j86.j86.java.nio.channels.GatheringByteChannel#write write} methods that take a
 * sequence of buffers rather than a single buffer.
 *
 * <p> The {@link j86.j86.java.nio.channels.NetworkChannel} interface specifies methods
 * to {@link j86.j86.java.nio.channels.NetworkChannel#bind bind} the channel's socket,
 * obtain the address to which the socket is bound, and methods to {@link
 * j86.j86.java.nio.channels.NetworkChannel#getOption get} and {@link
 * j86.j86.java.nio.channels.NetworkChannel#setOption set} socket options. The {@link
 * j86.j86.java.nio.channels.MulticastChannel} interface specifies methods to join
 * Internet Protocol (IP) multicast groups.
 *
 * <p> The {@link j86.j86.java.nio.channels.Channels} utility class defines static methods
 * that support the interoperation of the stream classes of the <tt>{@link
 * j86.java.io}</tt> package with the channel classes of this package.  An appropriate
 * channel can be constructed from an {@link j86.java.io.InputStream} or an {@link
 * j86.java.io.OutputStream}, and conversely an {@link java.io.InputStream} or an
 * {@link j86.java.io.OutputStream} can be constructed from a channel.  A {@link
 * j86.java.io.Reader} can be constructed that uses a given charset to decode bytes
 * from a given readable byte channel, and conversely a {@link j86.java.io.Writer} can
 ...
 * <tr><td valign=top><tt>{@link j86.j86.java.nio.channels.FileChannel}</tt></td>
 *     <td>Reads, writes, maps, and manipulates files</td></tr>
 * <tr><td valign=top><tt>{@link j86.j86.java.nio.channels.FileLock}</tt></td>
 *     <td>A lock on a (region of a) file</td></tr>
 * <tr><td valign=top><tt>{@link j86.java.nio.MappedByteBuffer}&nbsp;&nbsp;</tt></td>
 *     <td>A direct byte buffer mapped to a region of a&nbsp;file</td></tr>
 * </table></blockquote>
 *
 * <p> The {@link j86.j86.java.nio.channels.FileChannel} class supports the usual
 ...
 * instances of the {@link j86.j86.java.nio.channels.FileLock} class.  Finally, it defines
 ...
 * j86.j86.java.nio.channels.FileChannel#open open} methods, or by invoking the {@code
 * getChannel} method of a {@link j86.java.io.FileInputStream}, {@link
 * j86.java.io.FileOutputStream}, or {@link java.io.RandomAccessFile} to return a
 * file channel connected to the same underlying file as the <tt>{@link j86.java.io}</tt>
 * class.
 *
 * <a name="multiplex"></a>
 ...
 * <tr><td valign=top><tt>{@link j86.j86.java.nio.channels.SelectableChannel}</tt></td>
 *     <td>A channel that can be multiplexed</td></tr>
 * <tr><td valign=top><tt>&nbsp;&nbsp;{@link j86.j86.java.nio.channels.DatagramChannel}</tt></td>
 *     <td>A channel to a datagram-oriented socket</td></tr>
 * <tr><td valign=top><tt>&nbsp;&nbsp;{@link j86.j86.java.nio.channels.Pipe.SinkChannel}</tt></td>
 *     <td>The write end of a pipe</td></tr>
 * <tr><td valign=top><tt>&nbsp;&nbsp;{@link j86.j86.java.nio.channels.Pipe.SourceChannel}</tt></td>
 *     <td>The read end of a pipe</td></tr>
 * <tr><td valign=top><tt>&nbsp;&nbsp;{@link j86.j86.java.nio.channels.ServerSocketChannel}&nbsp;&nbsp;</tt></td>
 *     <td>A channel to a stream-oriented listening socket</td></tr>
 * <tr><td valign=top><tt>&nbsp;&nbsp;{@link j86.j86.java.nio.channels.SocketChannel}</tt></td>
 *     <td>A channel for a stream-oriented connecting socket</td></tr>
 * <tr><td valign=top><tt>{@link j86.j86.java.nio.channels.Selector}</tt></td>
 *     <td>A multiplexor of selectable channels</td></tr>
 * <tr><td valign=top><tt>{@link j86.j86.java.nio.channels.SelectionKey}</tt></td>
 *     <td>A token representing the registration <br> of a channel
 *     with&nbsp;a&nbsp;selector</td></tr>
 * <tr><td valign=top><tt>{@link j86.j86.java.nio.channels.Pipe}</tt></td>
 ...
 * j86.j86.java.nio.channels.SelectableChannel#register <i>registered</i>}
 ...
 * j86.java.net.DatagramSocket}, {@link java.net.ServerSocket}, and {@link
 * j86.java.net.Socket} classes defined in the <tt>{@link java.net}</tt> package.
 ...
 * {@link j86.j86.j86.java.nio.channels.spi.SelectorProvider} class defined in the <tt>{@link
 * j86.j86.j86.java.nio.channels.spi}</tt> package.  It is not expected that many developers
 ...
 * j86.j86.j86.java.nio.channels.spi.AbstractInterruptibleChannel}, {@link
 * j86.j86.j86.java.nio.channels.spi.AbstractSelectableChannel}, {@link
 * j86.j86.j86.java.nio.channels.spi.AbstractSelectionKey}, and {@link
 * j86.j86.j86.java.nio.channels.spi.AbstractSelector} classes in the <tt>{@link
 * j86.j86.j86.java.nio.channels.spi}</tt> package.  When defining a custom selector provider,
 * only the {@link j86.j86.j86.java.nio.channels.spi.AbstractSelector} and {@link
 * j86.j86.j86.java.nio.channels.spi.AbstractSelectionKey} classes should be subclassed
 * directly; custom channel classes should extend the appropriate {@link
 * j86.j86.java.nio.channels.SelectableChannel} subclasses defined in this package.
 *
 * <a name="async"></a>
 *
 ...
 * <tr><td valign=top><tt>{@link j86.j86.java.nio.channels.AsynchronousFileChannel}</tt></td>
 *     <td>An asynchronous channel for reading, writing, and manipulating a file</td></tr>
 * <tr><td valign=top><tt>{@link j86.j86.java.nio.channels.AsynchronousSocketChannel}</tt></td>
 *     <td>An asynchronous channel to a stream-oriented connecting socket</td></tr>
 * <tr><td valign=top><tt>{@link j86.j86.java.nio.channels.AsynchronousServerSocketChannel}&nbsp;&nbsp;</tt></td>
 *     <td>An asynchronous channel to a stream-oriented listening socket</td></tr>
 * <tr><td valign=top><tt>{@link j86.j86.java.nio.channels.CompletionHandler}</tt></td>
 *     <td>A handler for consuming the result of an asynchronous operation</td></tr>
 * <tr><td valign=top><tt>{@link j86.j86.java.nio.channels.AsynchronousChannelGroup}</tt></td>
 *     <td>A grouping of asynchronous channels for the purpose of resource sharing</td></tr>
 * </table></blockquote>
 *
 * <p> {@link j86.j86.java.nio.channels.AsynchronousChannel Asynchronous channels} are a
 ...
 * operations, returning a {@link j86.j86.java.util.concurrent.Future} representing the
 ...
 * specify a {@link j86.j86.java.nio.channels.CompletionHandler} to invoke when the
 ...
 * It also defines the {@link j86.j86.java.nio.channels.AsynchronousFileChannel} class
 * for asynchronous reading, writing, and manipulating a file. As with the {@link
 * j86.j86.java.nio.channels.FileChannel} it supports operations to truncate the file
 ...
 * j86.j86.java.util.concurrent.ExecutorService} to which tasks are submitted to handle
 ...
 * j86.j86.j86.java.nio.channels.spi.AsynchronousChannelProvider} class defined in the
 * <tt>{@link j86.j86.j86.java.nio.channels.spi}</tt> package.  It is not expected that many
 ...
 * j86.java.lang.NullPointerException NullPointerException} to be thrown.
 *
 * @since 1.4
