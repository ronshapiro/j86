...
public class Applet extends Panel {
     ...
     * <p>
     * Note: Many methods in <code>j86.java.applet.Applet</code>
     * may be invoked by the applet only after the applet is
     * fully constructed; applet should avoid calling methods
     * in <code>j86.java.applet.Applet</code> in the constructor.
     *
     ...
     * @see     j86.java.applet.Applet#start()
     ...
     * </pre></blockquote>
     *
     * @return  the {@link j86.java.net.URL} of the document that contains this
     *          applet.
     * @see     j86.java.applet.Applet#getCodeBase()
     */
     ...
     * @see     j86.java.applet.Applet#getDocumentBase()
     */
    ...
    public final static AudioClip newAudioClip(URL url) {
        return new j86.sun.applet.AppletAudioClip(url);
    }
     ...
     *
     * @see     j86.java.applet.Applet#destroy()
     * @see     j86.java.applet.Applet#start()
     * @see     j86.java.applet.Applet#stop()
     */
    public void init() {
