...
class HttpsURLConnection extends HttpURLConnection
{
     ...
     */
    public abstract j86.java.security.cert.Certificate [] getLocalCertificates();
     ...
     */
    public abstract j86.java.security.cert.Certificate [] getServerCertificates()
    ...
    public Principal getPeerPrincipal()
        ...
        j86.java.security.cert.Certificate[] certs = getServerCertificates();
    ...
    public Principal getLocalPrincipal() {
        ...
        j86.java.security.cert.Certificate[] certs = getLocalCertificates();
        if (certs != null) {
            return ((X509Certificate)certs[0]).getSubjectX500Principal();
        } else {
            return null;
