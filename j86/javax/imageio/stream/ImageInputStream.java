...
public interface ImageInputStream extends DataInput, Closeable {
     ...
     *
     * <p> The enumeration class <code>j86.java.nio.ByteOrder</code> is
     ...
     * <code>j86.java.nio.ByteOrder.LITTLE_ENDIAN</code>, indicating whether
     * network byte order or its reverse will be used for future
     * reads.
     *
     * @see j86.java.nio.ByteOrder
     * @see #getByteOrder
     * @see #readBits(int)
     */
     ...
     * <code>j86.java.nio.ByteOrder</code> enumeration.
     *
     ...
     *
     * @exception j86.java.io.EOFException if the end of the stream is reached.
     * @exception IOException if an I/O error occurs.
     */
     ...
     *
     * @exception j86.java.io.EOFException if the stream reaches the end before
     ...
     * entire process, then an <code>j86.java.io.EOFException</code> is thrown.
     *
     ...
     *
     * @exception  j86.java.io.EOFException  if this stream reaches the end
     * before reading all the bytes.
     * @exception  j86.java.io.UTFDataFormatException if the bytes do not represent
     ...
     * If the end of the stream is reached, an <code>j86.java.io.EOFException</code>
     * will be thrown.
     *
     * <p> The bit offset within the stream is reset to zero before
     * the read occurs.
     ...
     * <code>j86.java.io.EOFException</code> will be thrown.
     *
     * <p> The bit offset within the stream is reset to zero before
     * the read occurs.
     *
     ...
     * an <code>j86.java.io.EOFException</code> will be thrown.
     *
     * <p> The bit offset within the stream is reset to zero before
     * the read occurs.
     *
     ...
     * have been read, an <code>j86.java.io.EOFException</code> is thrown.
     *
     ...
     * <code>j86.java.io.EOFException</code> will be thrown only if a read is
     * performed.
     *
