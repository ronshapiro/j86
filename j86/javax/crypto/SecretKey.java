 ...
 * {@link j86.java.lang.Object}, so that secret keys are compared based on
 ...
 * from the {@link j86.java.security.Key} parent interface.)
 *
 * @author Jan Luehe
 *
...
public interface SecretKey extends
    j86.java.security.Key, j86.javax.security.auth.Destroyable {
