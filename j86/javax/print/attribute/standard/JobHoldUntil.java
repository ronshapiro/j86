 ...
 * month, day, hour, minute, and so on, use a {@link j86.java.util.Calendar
 * Calendar} object to construct a {@link j86.java.util.Date Date} object, then use
 * the {@link j86.java.util.Date Date} object to construct the JobHoldUntil
 * attribute. To convert a JobHoldUntil attribute to separate values of the
 * year, month, day, hour, minute, and so on, create a {@link j86.java.util.Calendar
 * Calendar} object and set it to the {@link j86.java.util.Date Date} from the
...
public final class JobHoldUntil extends DateTimeSyntax
     ...
     * {@link j86.java.util.Date Date} value.
     *
     ...
     * <LI>
     * This job hold until attribute's {@link j86.java.util.Date Date} value and
     * <CODE>object</CODE>'s {@link j86.java.util.Date Date} value are equal.
     * </OL>
     *
