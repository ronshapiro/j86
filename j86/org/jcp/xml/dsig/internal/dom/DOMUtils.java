...
public class DOMUtils {
                                       ...
                                       XSLTTransformParameterSpec spec2)
    {
        ...
        if (!(ostylesheet instanceof j86.javax.xml.crypto.dom.DOMStructure)) {
            return false;
        }
        Node ostylesheetElem =
            ((j86.javax.xml.crypto.dom.DOMStructure) ostylesheet).getNode();
        XMLStructure stylesheet = spec1.getStylesheet();
        Node stylesheetElem =
            ((j86.javax.xml.crypto.dom.DOMStructure) stylesheet).getNode();
