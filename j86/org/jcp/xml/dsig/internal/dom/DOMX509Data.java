...
import j86.javax.xml.crypto.dsig.keyinfo.X509IssuerSerial;
import j86.javax.xml.crypto.dsig.keyinfo.X509Data;
        ...
        for (int i = 0, size = content.size(); i < size; i++) {
            ...
            if (object instanceof X509Certificate) {
                ...
                if (object instanceof X509IssuerSerial) {
                    ...
                    j86.javax.xml.crypto.dom.DOMStructure domContent =
                        (j86.javax.xml.crypto.dom.DOMStructure)object;
