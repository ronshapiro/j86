...
public class MibLogger {
    ...
    static String getLoggerName(Class<?> clazz) {
        if (clazz == null) return "j86.sun.management.snmp.jvminstr";
        Package p = clazz.getPackage();
        if (p == null) return "j86.sun.management.snmp.jvminstr";
        final String pname = p.getName();
        if (pname == null) return "j86.sun.management.snmp.jvminstr";
        else return pname;
    }
    ...
    public MibLogger(String className) {
        this("j86.sun.management.snmp.jvminstr",className);
    }
