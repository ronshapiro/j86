...
import j86.com.sun.jmx.snmp.agent.SnmpMibNode;
...
public abstract class JVM_MANAGEMENT_MIB extends SnmpMib implements Serializable {
    ...
    protected void initJvmOS(MBeanServer server)
        ...
        if (server != null) {
            objname = getGroupObjectName("JvmOS", oid, mibName + ":name=j86.sun.management.snmp.jvmmib.JvmOS");
        }
    ...
    protected void initJvmCompilation(MBeanServer server)
        ...
        ObjectName objname = null;
        if (server != null) {
            objname = getGroupObjectName("JvmCompilation", oid, mibName + ":name=j86.sun.management.snmp.jvmmib.JvmCompilation");
        }
    ...
    protected void initJvmRuntime(MBeanServer server)
        ...
        ObjectName objname = null;
        if (server != null) {
            objname = getGroupObjectName("JvmRuntime", oid, mibName + ":name=j86.sun.management.snmp.jvmmib.JvmRuntime");
        }
    ...
    protected void initJvmThreading(MBeanServer server)
        ...
        ObjectName objname = null;
        if (server != null) {
            objname = getGroupObjectName("JvmThreading", oid, mibName + ":name=j86.sun.management.snmp.jvmmib.JvmThreading");
        }
    ...
    protected void initJvmMemory(MBeanServer server)
        ...
        ObjectName objname = null;
        if (server != null) {
            objname = getGroupObjectName("JvmMemory", oid, mibName + ":name=j86.sun.management.snmp.jvmmib.JvmMemory");
        }
    ...
    protected void initJvmClassLoading(MBeanServer server)
        ...
        ObjectName objname = null;
        if (server != null) {
            objname = getGroupObjectName("JvmClassLoading", oid, mibName + ":name=j86.sun.management.snmp.jvmmib.JvmClassLoading");
        }
