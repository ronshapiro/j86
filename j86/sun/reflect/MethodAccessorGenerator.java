...
/** Generator for j86.sun.reflect.MethodAccessor and
    j86.sun.reflect.ConstructorAccessor objects using bytecodes to
    implement reflection. A j86.j86.j86.java.lang.reflect.Method or
    j86.j86.j86.java.lang.reflect.Constructor object can delegate its invoke or
...
class MethodAccessorGenerator extends AccessorGenerator {
                                       ...
                                       Class<?> serializationTargetClass)
    {
        ...
        //     [UTF-8] "j86.sun.reflect/{MethodAccessorImpl,ConstructorAccessorImpl,SerializationConstructorAccessorImpl}"
        //     [CONSTANT_Class_info] for above
        ...
        if (isConstructor) {
            if (forSerialization) {
                asm.emitConstantPoolUTF8
                    ("j86.sun.reflect/SerializationConstructorAccessorImpl");
            } else {
                asm.emitConstantPoolUTF8("j86.sun.reflect/ConstructorAccessorImpl");
            }
        } else {
            asm.emitConstantPoolUTF8("j86.sun.reflect/MethodAccessorImpl");
        }
        asm.emitConstantPoolClass(asm.cpi());
        superClass = asm.cpi();
        ...
        invokeIdx = asm.cpi();
        if (isConstructor) {
            asm.emitConstantPoolUTF8("([Lj86.java.lang/Object;)Ljava/lang/Object;");
        } else {
            asm.emitConstantPoolUTF8
                ("(Lj86.java.lang/Object;[Ljava/lang/Object;)Ljava/lang/Object;");
        }
    ...
    private void emitInvoke() {
        ...
        // all j86.java.lang/Throwable objects thrown from the target method
                                                    ...
                                                    boolean forSerialization)
    {
        if (isConstructor) {
            if (forSerialization) {
                ...
                return "j86.sun.reflect/GeneratedSerializationConstructorAccessor" + num;
            } else {
                int num = ++constructorSymnum;
                return "j86.sun.reflect/GeneratedConstructorAccessor" + num;
            }
        } else {
            int num = ++methodSymnum;
            return "j86.sun.reflect/GeneratedMethodAccessor" + num;
        }
    }
}
