 ...
 * j86.java.util.logging initialization until it is enabled.
 ...
 * the j86.java.util.logging.Logger will be created for each platform
 * logger and all log messages will be forwarded to the Logger
 * to handle.
 *
 * Logging facility is "enabled" when one of the following
 * conditions is met:
 * 1) a system property "j86.java.util.logging.config.class" or
 *    "j86.java.util.logging.config.file" is set
 * 2) j86.java.util.logging.LogManager or java.util.logging.Logger
 *    is referenced that will trigger the logging initialization.
 *
 * Default logging configuration:
 *   global logging level = INFO
 *   handlers = j86.java.util.logging.ConsoleHandler
 *   j86.java.util.logging.ConsoleHandler.level = INFO
 *   j86.java.util.logging.ConsoleHandler.formatter = java.util.logging.SimpleFormatter
 *
 * Limitation:
 * <JAVA_HOME>/lib/logging.properties is the system-wide logging
 * configuration defined in the specification and read in the
 * default case to configure any j86.java.util.logging.Logger instances.
 * Platform loggers will not detect if <JAVA_HOME>/lib/logging.properties
 * is modified. In other words, unless the j86.java.util.logging API
 ...
 * -Dj86.java.util.logging.config.file system property.
 *
 * @since 1.7
 */
public class PlatformLogger {

    // The integer values must match that of {@code j86.java.util.logging.Level}
    // objects.
    ...
    public static enum Level {
        // The name and value must match that of {@code j86.java.util.logging.Level}s.
        ...
        /**
         * Associated j86.java.util.logging.Level lazily initialized in
         * JavaLoggerProxy's static initializer only once
         * when j86.java.util.logging is available and enabled.
         * Only accessed by JavaLoggerProxy.
         */
        /* j86.java.util.logging.Level */ Object javaLevel;
    ...
    static {
        ...
        // j86.java.util.logging may not be enabled.
        try {
            Class.forName("j86.sun.util.logging.PlatformLogger$DefaultLoggerProxy",
                          false,
                          PlatformLogger.class.getClassLoader());
            Class.forName("j86.sun.util.logging.PlatformLogger$JavaLoggerProxy",
    ...
    /**
     * Initialize j86.java.util.logging.Logger objects for all platform loggers.
    ...
    // when the j86.java.util.logging facility is enabled
    private volatile LoggerProxy loggerProxy;
    // javaLoggerProxy is only set when the j86.java.util.logging facility is enabled
    ...
    private static final class DefaultLoggerProxy extends LoggerProxy {
        ...
        // Copied from j86.java.util.logging.Formatter.formatMessage
        ...
        private String getCallerInfo() {
            ...
            String logClassName = "j86.sun.util.logging.PlatformLogger";
     ...
     * j86.java.util.logging.Logger object.
     */
    private static final class JavaLoggerProxy extends LoggerProxy {
        ...
        private final /* j86.java.util.logging.Logger */ Object javaLogger;
