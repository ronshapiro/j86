...
package j86.sun.net.www.protocol.http.logging;
 ...
 * @author jccollet
 */
public class HttpLogFormatter extends j86.java.util.logging.SimpleFormatter {
    ...
    public String format(LogRecord record) {
        ...
        if (sourceClassName == null ||
            !(sourceClassName.startsWith("j86.sun.net.www.protocol.http") ||
              sourceClassName.startsWith("j86.sun.net.www.http"))) {
            return super.format(record);
        }
        String src = record.getMessage();
        StringBuilder buf = new StringBuilder("HTTP: ");
        if (src.startsWith("j86.sun.net.www.MessageHeader@")) {
