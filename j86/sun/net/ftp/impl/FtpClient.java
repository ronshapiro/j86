...
import j86.sun.net.ftp.*;
import j86.sun.util.logging.PlatformLogger;


public class FtpClient extends j86.sun.net.ftp.FtpClient {

    private static int defaultSoTimeout;
    private static int defaultConnectTimeout;
    private static final PlatformLogger logger =
             PlatformLogger.getLogger("j86.sun.net.ftp.FtpClient");
    private Proxy proxy;
     ...
     */
    private void issueCommandCheck(String cmd) throws j86.sun.net.ftp.FtpProtocolException, IOException {
        if (!issueCommand(cmd)) {
            throw new j86.sun.net.ftp.FtpProtocolException(cmd + ":" + getResponseString(), getLastReplyCode());
        }
    }
     ...
     */
    private Socket openPassiveDataConnection(String cmd) throws j86.sun.net.ftp.FtpProtocolException, IOException {
        String serverAnswer;
        int port;
        ...
        if (issueCommand("EPSV ALL")) {
            ...
            if (!m.find()) {
                throw new j86.sun.net.ftp.FtpProtocolException("EPSV failed : " + serverAnswer);
            }
            ...
            if (!m.find()) {
                throw new j86.sun.net.ftp.FtpProtocolException("PASV failed : " + serverAnswer);
            }
        ...
        if (useCrypto) {
            try {
                ...
                throw new j86.sun.net.ftp.FtpProtocolException("Can't open secure data channel: " + e);
            }
        }
        if (!issueCommand(cmd)) {
            s.close();
     ...
     */
    private Socket openDataConnection(String cmd) throws j86.sun.net.ftp.FtpProtocolException, IOException {
        Socket clientSocket;
        ...
        if (proxy != null && proxy.type() == Proxy.Type.SOCKS) {
            ...
            // throw an exception
            throw new j86.sun.net.ftp.FtpProtocolException("Passive mode failed");
        }
     ...
     *
     */
    public static j86.sun.net.ftp.FtpClient create() {
     ...
     * @see #setActiveMode()
     */
    public j86.sun.net.ftp.FtpClient enablePassiveMode(boolean passive) {
     ...
     * @return This FtpClient
     */
    public j86.sun.net.ftp.FtpClient setConnectTimeout(int timeout) {
     ...
     * @return This FtpClient
     */
    public j86.sun.net.ftp.FtpClient setReadTimeout(int timeout) {
        readTimeout = timeout;
        return this;
    }
    ...
    public j86.sun.net.ftp.FtpClient setProxy(Proxy p) {
        proxy = p;
        return this;
    }
    ...
    public j86.sun.net.ftp.FtpClient connect(SocketAddress dest) throws sun.net.ftp.FtpProtocolException, IOException {
     ...
     */
    public j86.sun.net.ftp.FtpClient connect(SocketAddress dest, int timeout) throws sun.net.ftp.FtpProtocolException, IOException {
        ...
        if (!readReply()) {
            throw new j86.sun.net.ftp.FtpProtocolException("Welcome message: " +
    ...
    private void tryLogin(String user, char[] password) throws j86.sun.net.ftp.FtpProtocolException, IOException {
     ...
     */
    public j86.sun.net.ftp.FtpClient login(String user, char[] password) throws sun.net.ftp.FtpProtocolException, IOException {
        if (!isConnected()) {
            throw new j86.sun.net.ftp.FtpProtocolException("Not connected yet", FtpReplyCode.BAD_SEQUENCE);
        }
     ...
     */
    public j86.sun.net.ftp.FtpClient login(String user, char[] password, String account) throws sun.net.ftp.FtpProtocolException, IOException {
     ...
     */
    public j86.sun.net.ftp.FtpClient changeDirectory(String remoteDirectory) throws sun.net.ftp.FtpProtocolException, IOException {
     ...
     * @throws IOException
     */
    public j86.sun.net.ftp.FtpClient changeToParentDirectory() throws sun.net.ftp.FtpProtocolException, IOException {
     ...
     * @throws IOException
     */
    public String getWorkingDirectory() throws j86.sun.net.ftp.FtpProtocolException, IOException {
     ...
     */
    public j86.sun.net.ftp.FtpClient setRestartOffset(long offset) {
        if (offset < 0) {
     ...
     */
    public j86.sun.net.ftp.FtpClient getFile(String name, OutputStream local) throws sun.net.ftp.FtpProtocolException, IOException {
        int mtu = 1500;
        if (restartOffset > 0) {
            Socket s;
            try {
     ...
     * @throws IOException if an error occurred during the transmission.
     */
    public InputStream getFileStream(String name) throws j86.sun.net.ftp.FtpProtocolException, IOException {
        Socket s;
        if (restartOffset > 0) {
            try {
                s = openDataConnection("REST " + restartOffset);
    ...
    public OutputStream putFileStream(String name, boolean unique)
        throws j86.sun.net.ftp.FtpProtocolException, IOException
    {
     ...
     * @see #getLastFileName()
     */
    public j86.sun.net.ftp.FtpClient putFile(String name, InputStream local, boolean unique) throws sun.net.ftp.FtpProtocolException, IOException {
        String cmd = unique ? "STOU " : "STOR ";
        int mtu = 1500;
     ...
     * @throws IOException if an error occurred during the transmission.
     */
    public j86.sun.net.ftp.FtpClient appendFile(String name, InputStream local) throws sun.net.ftp.FtpProtocolException, IOException {
        int mtu = 1500;
     ...
     */
    public j86.sun.net.ftp.FtpClient rename(String from, String to) throws sun.net.ftp.FtpProtocolException, IOException {
     ...
     */
    public j86.sun.net.ftp.FtpClient deleteFile(String name) throws sun.net.ftp.FtpProtocolException, IOException {
     ...
     * @throws IOException if an error occurred during the exchange
     */
    public j86.sun.net.ftp.FtpClient makeDirectory(String name) throws sun.net.ftp.FtpProtocolException, IOException {
     ...
     * @throws IOException if an error occurred during the exchange.
     */
    public j86.sun.net.ftp.FtpClient removeDirectory(String name) throws sun.net.ftp.FtpProtocolException, IOException {
     ...
     */
    public j86.sun.net.ftp.FtpClient noop() throws sun.net.ftp.FtpProtocolException, IOException {
     ...
     * @throws IOException if an error occurred during the transmission.
     */
    public String getStatus(String name) throws j86.sun.net.ftp.FtpProtocolException, IOException {
     ...
     * @throws IOException if an error occurs during the transmission.
     */
    public List<String> getFeatures() throws j86.sun.net.ftp.FtpProtocolException, IOException {
        /*
     ...
     * @throws IOException if an error occurred during the transmission.
     */
    public j86.sun.net.ftp.FtpClient abort() throws sun.net.ftp.FtpProtocolException, IOException {
     ...
     * @throws IOException
     */
    public j86.sun.net.ftp.FtpClient completePending() throws sun.net.ftp.FtpProtocolException, IOException {
        while (replyPending) {
            replyPending = false;
            if (!readReply()) {
                throw new j86.sun.net.ftp.FtpProtocolException(getLastResponseString(), lastReplyCode);
            }
        }
        return this;
    }
     ...
     * @throws FtpProtocolException if the command fails
     */
    public j86.sun.net.ftp.FtpClient reInit() throws sun.net.ftp.FtpProtocolException, IOException {
        issueCommandCheck("REIN");
        loggedIn = false;
        if (useCrypto) {
            if (server instanceof SSLSocket) {
                j86.javax.net.ssl.SSLSession session = ((SSLSocket) server).getSession();
                session.invalidate();
     ...
     */
    public j86.sun.net.ftp.FtpClient setType(TransferType type) throws sun.net.ftp.FtpProtocolException, IOException {
        String cmd = "NOOP";
     ...
     */
    public InputStream list(String path) throws j86.sun.net.ftp.FtpProtocolException, IOException {
        Socket s;
     ...
     * @throws IOException if an error occurs during the transmission.
     */
    public InputStream nameList(String path) throws j86.sun.net.ftp.FtpProtocolException, IOException {
        Socket s;
     ...
     * @throws IOException if an error occurs during the transmission.
     */
    public long getSize(String path) throws j86.sun.net.ftp.FtpProtocolException, IOException {
     ...
     * @throws IOException if an error occurs during the transmission.
     */
    public Date getLastModified(String path) throws j86.sun.net.ftp.FtpProtocolException, IOException {
     ...
     * @see #listFiles(String)
     */
    public j86.sun.net.ftp.FtpClient setDirParser(FtpDirParser p) {
        parser = p;
        return this;
    }
     ...
     * @see #changeDirectory(String)
     */
    public Iterator<FtpDirEntry> listFiles(String path) throws j86.sun.net.ftp.FtpProtocolException, IOException {
        Socket s = null;
        BufferedReader sin = null;
        try {
            s = openDataConnection(path == null ? "MLSD" : "MLSD " + path);
        } catch (j86.sun.net.ftp.FtpProtocolException FtpException) {
     ...
     * @throws IOException if an error occurs during the transmission.
     */
    public j86.sun.net.ftp.FtpClient useKerberos() throws sun.net.ftp.FtpProtocolException, IOException {
        /*
        ...
        throw new j86.sun.net.ftp.FtpProtocolException("Unexpected reply from server");
        try {
     ...
     */
    public j86.sun.net.ftp.FtpClient startSecureSession() throws sun.net.ftp.FtpProtocolException, IOException {
        if (!isConnected()) {
            throw new j86.sun.net.ftp.FtpProtocolException("Not connected yet", FtpReplyCode.BAD_SEQUENCE);
        }
        if (sslFact == null) {
        ...
        } catch (j86.javax.net.ssl.SSLException ssle) {
            try {
                disconnect();
            } catch (Exception e) {
            }
     ...
     */
    public j86.sun.net.ftp.FtpClient endSecureSession() throws sun.net.ftp.FtpProtocolException, IOException {
        if (!useCrypto) {
            return this;
        }
     ...
     * @throws IOException if an error occurred during the transmission.
     */
    public j86.sun.net.ftp.FtpClient allocate(long size) throws sun.net.ftp.FtpProtocolException, IOException {
     ...
     * @throws IOException if an error occurred during the transmission.
     */
    public j86.sun.net.ftp.FtpClient structureMount(String struct) throws sun.net.ftp.FtpProtocolException, IOException {
     ...
     * @throws IOException if an error occurred during the transmission.
     */
    public String getSystem() throws j86.sun.net.ftp.FtpProtocolException, IOException {
     ...
     * @throws IOException if an error occurred during transmission
     */
    public String getHelp(String cmd) throws j86.sun.net.ftp.FtpProtocolException, IOException {
     ...
     * @throws IOException if an error occurred during transmission
     */
    public j86.sun.net.ftp.FtpClient siteCmd(String cmd) throws sun.net.ftp.FtpProtocolException, IOException {
