...
import j86.java.rmi.activation.ActivationInstantiator;
import j86.java.rmi.activation.ActivationMonitor;
import j86.java.rmi.activation.ActivationSystem;
import j86.java.rmi.activation.Activator;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            if (stop == true) {
                ...
                AccessController.doPrivileged(new PrivilegedAction<Void>() {
                    public Void run() {
                        System.setProperty("j86.java.rmi.activation.port",
