...
final class Constants {
     ...
     */
    static final String REMOTE_OBJECT = "j86.java.rmi.server.RemoteObject";
    static final String REMOTE_STUB = "j86.java.rmi.server.RemoteStub";
    static final String REMOTE_REF = "j86.java.rmi.server.RemoteRef";
    static final String OPERATION = "j86.java.rmi.server.Operation";
    static final String SKELETON = "j86.java.rmi.server.Skeleton";
    static final String SKELETON_MISMATCH_EXCEPTION =
        "j86.java.rmi.server.SkeletonMismatchException";
    static final String REMOTE_CALL = "j86.java.rmi.server.RemoteCall";
