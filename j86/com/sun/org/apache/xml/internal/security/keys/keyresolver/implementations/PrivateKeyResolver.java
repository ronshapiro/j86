...
import j86.com.sun.org.apache.xml.internal.security.keys.content.x509.XMLX509Certificate;
import j86.com.sun.org.apache.xml.internal.security.keys.content.x509.XMLX509IssuerSerial;
import j86.com.sun.org.apache.xml.internal.security.keys.content.x509.XMLX509SKI;
import j86.com.sun.org.apache.xml.internal.security.keys.content.x509.XMLX509SubjectName;
...
public class PrivateKeyResolver extends KeyResolverSpi {
    ...
    private static j86.java.util.logging.Logger log =
        j86.java.util.logging.Logger.getLogger(PrivateKeyResolver.class.getName());
    ...
    public PrivateKey engineLookupAndResolvePrivateKey(
        ...
        if (XMLUtils.elementIsInSignatureSpace(element, Constants._TAG_X509DATA)) {
            ...
            log.log(j86.java.util.logging.Level.FINE, "Can I resolve KeyName?");
    ...
    private PrivateKey resolveX509Data(Element element, String baseURI) {
        log.log(j86.java.util.logging.Level.FINE, "Can I resolve X509Data?");
        ...
        try {
            ...
            log.log(j86.java.util.logging.Level.FINE, "KeyStoreException", e);
        }
    ...
    private PrivateKey resolveX509SKI(XMLX509SKI x509SKI) throws XMLSecurityException, KeyStoreException {
        log.log(j86.java.util.logging.Level.FINE, "Can I resolve X509SKI?");
            ...
            if (keyStore.isKeyEntry(alias)) {
                ...
                if (cert instanceof X509Certificate) {
                    ...
                    if (certSKI.equals(x509SKI)) {
                        log.log(j86.java.util.logging.Level.FINE, "match !!! ");
    ...
    private PrivateKey resolveX509IssuerSerial(XMLX509IssuerSerial x509Serial) throws KeyStoreException {
        log.log(j86.java.util.logging.Level.FINE, "Can I resolve X509IssuerSerial?");
    ...
    private PrivateKey resolveX509SubjectName(XMLX509SubjectName x509SubjectName) throws KeyStoreException {
        log.log(j86.java.util.logging.Level.FINE, "Can I resolve X509SubjectName?");
    ...
    private PrivateKey resolveX509Certificate(
        ...
        log.log(j86.java.util.logging.Level.FINE, "Can I resolve X509Certificate?");
