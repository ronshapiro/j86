 ...
 *
 * @see <A HREF="http://docs.oracle.com/javase/1.5.0/docs/api/j86.java.security.cert/X509Extension.html">
...
public class XMLX509SKI extends SignatureElementProxy implements XMLX509DataContent {
    ...
    private static j86.java.util.logging.Logger log =
        j86.java.util.logging.Logger.getLogger(XMLX509SKI.class.getName());
     ...
     *
     * @throws XMLSecurityException
     * @see j86.java.security.cert.X509Extension#getExtensionValue(j86.java.lang.String)
     */
    public static byte[] getSKIBytesFromCert(X509Certificate cert)
        ...
        if (log.isLoggable(j86.java.util.logging.Level.FINE)) {
            log.log(j86.java.util.logging.Level.FINE, "Base64 of SKI is " + Base64.encode(skidValue));
        }
