...
import j86.com.sun.org.apache.xml.internal.security.signature.reference.ReferenceData;
import j86.com.sun.org.apache.xml.internal.security.signature.reference.ReferenceNodeSetData;
import j86.com.sun.org.apache.xml.internal.security.signature.reference.ReferenceOctetStreamData;
import j86.com.sun.org.apache.xml.internal.security.signature.reference.ReferenceSubTreeData;
...
import j86.com.sun.org.apache.xml.internal.security.utils.DigesterOutputStream;
...
public class Reference extends SignatureElementProxy {
    ...
    private static final j86.java.util.logging.Logger log =
        j86.java.util.logging.Logger.getLogger(Reference.class.getName());
    ...
    public boolean verify()
        ...
        if (!equal) {
            log.log(j86.java.util.logging.Level.WARNING, "Verification failed for URI \"" + this.getURI() + "\"");
            log.log(j86.java.util.logging.Level.WARNING, "Expected Digest: " + Base64.encode(elemDig));
            log.log(j86.java.util.logging.Level.WARNING, "Actual Digest: " + Base64.encode(calcDig));
        } else {
            if (log.isLoggable(j86.java.util.logging.Level.FINE)) {
                log.log(j86.java.util.logging.Level.FINE, "Verification successful for URI \"" + this.getURI() + "\"");
            }
        }
