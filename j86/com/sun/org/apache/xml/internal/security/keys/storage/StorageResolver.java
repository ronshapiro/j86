...
import j86.com.sun.org.apache.xml.internal.security.keys.storage.implementations.KeyStoreResolver;
import j86.com.sun.org.apache.xml.internal.security.keys.storage.implementations.SingleCertificateResolver;
...
public class StorageResolver {
    ...
    private static j86.java.util.logging.Logger log =
        j86.java.util.logging.Logger.getLogger(StorageResolver.class.getName());
    ...
    public void add(KeyStore keyStore) {
        try {
            ...
            log.log(j86.java.util.logging.Level.SEVERE, "Could not add KeyStore because of: ", ex);
        }
    }
