...
public abstract class Canonicalizer11 extends CanonicalizerBase {
    ...
    private static j86.java.util.logging.Logger log =
        j86.java.util.logging.Logger.getLogger(Canonicalizer11.class.getName());
                    ...
                    if (base == null) {
                        ...
                        try {
                            ...
                            if (log.isLoggable(j86.java.util.logging.Level.FINE)) {
                                log.log(j86.java.util.logging.Level.FINE, ue.getMessage(), ue);
                            }
                        }
                    }
                }
     ...
     * {@link j86.com.sun.org.apache.xml.internal.security.utils.XMLUtils#circumventBug2650(
    ...
    private static String removeDotSegments(String path) {
        if (log.isLoggable(j86.java.util.logging.Level.FINE)) {
            log.log(j86.java.util.logging.Level.FINE, "STEP   OUTPUT BUFFER\t\tINPUT BUFFER");
        }
    ...
    private static void printStep(String step, String output, String input) {
        if (log.isLoggable(j86.java.util.logging.Level.FINE)) {
            log.log(j86.java.util.logging.Level.FINE, " " + step + ":   " + output);
            if (output.length() == 0) {
                log.log(j86.java.util.logging.Level.FINE, "\t\t\t\t" + input);
            } else {
                log.log(j86.java.util.logging.Level.FINE, "\t\t\t" + input);
            }
        }
