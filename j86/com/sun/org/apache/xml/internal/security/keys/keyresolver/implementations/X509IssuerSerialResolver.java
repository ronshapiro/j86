...
public class X509IssuerSerialResolver extends KeyResolverSpi {
    ...
    private static j86.java.util.logging.Logger log =
        j86.java.util.logging.Logger.getLogger(X509IssuerSerialResolver.class.getName());
    ...
    public X509Certificate engineLookupResolveX509Certificate(
        ...
        try {
            ...
            while (storageIterator.hasNext()) {
                ...
                if (log.isLoggable(j86.java.util.logging.Level.FINE)) {
                    log.log(j86.java.util.logging.Level.FINE, "Found Certificate Issuer: " + certSerial.getIssuerName());
                    log.log(j86.java.util.logging.Level.FINE, "Found Certificate Serial: " + certSerial.getSerialNumber().toString());
                }
                ...
                for (int i = 0; i < noOfISS; i++) {
                    ...
                    if (log.isLoggable(j86.java.util.logging.Level.FINE)) {
                        log.log(j86.java.util.logging.Level.FINE, "Found Element Issuer:     "
                                  + xmliss.getIssuerName());
                        log.log(j86.java.util.logging.Level.FINE, "Found Element Serial:     "
                    ...
                    if (log.isLoggable(j86.java.util.logging.Level.FINE)) {
                        log.log(j86.java.util.logging.Level.FINE, "no match...");
                    }
                }
            }
