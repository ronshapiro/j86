...
public class Init {
    ...
    private static j86.java.util.logging.Logger log =
        j86.java.util.logging.Logger.getLogger(Init.class.getName());
    ...
    private static void dynamicInit() {
        ...
        if (log.isLoggable(j86.java.util.logging.Level.FINE)) {
            log.log(j86.java.util.logging.Level.FINE, "Registering default algorithms");
        }
        try {
            //
            ...
            log.log(j86.java.util.logging.Level.SEVERE, ex.getMessage(), ex);
            ex.printStackTrace();
        }
    }
    ...
    private static void fileInit(InputStream is) {
        try {
            ...
            if (config == null) {
                log.log(j86.java.util.logging.Level.SEVERE, "Error in reading configuration file - Configuration element not found");
                return;
            }
            for (Node el = config.getFirstChild(); el != null; el = el.getNextSibling()) {
                ...
                if (tag.equals("CanonicalizationMethods")) {
                    ...
                    for (int i = 0; i < list.length; i++) {
                        ...
                        try {
                            ...
                            if (log.isLoggable(j86.java.util.logging.Level.FINE)) {
                                log.log(j86.java.util.logging.Level.FINE, "Canonicalizer.register(" + uri + ", " + javaClass + ")");
                            }
                        } catch (ClassNotFoundException e) {
                            Object exArgs[] = { uri, javaClass };
                            log.log(j86.java.util.logging.Level.SEVERE, I18n.translate("algorithm.classDoesNotExist", exArgs));
                        }
                    }
                }
                ...
                if (tag.equals("TransformAlgorithms")) {
                    ...
                    for (int i = 0; i < tranElem.length; i++) {
                        ...
                        try {
                            ...
                            if (log.isLoggable(j86.java.util.logging.Level.FINE)) {
                                log.log(j86.java.util.logging.Level.FINE, "Transform.register(" + uri + ", " + javaClass + ")");
                            }
                        } catch (ClassNotFoundException e) {
                            Object exArgs[] = { uri, javaClass };
                            ...
                            log.log(j86.java.util.logging.Level.WARNING, "Not able to found dependencies for algorithm, I'll keep working.");
                        }
                    }
                }
                ...
                if (tag.equals("SignatureAlgorithms")) {
                    ...
                    for (int i = 0; i < sigElems.length; i++) {
                        ...
                        try {
                            ...
                            if (log.isLoggable(j86.java.util.logging.Level.FINE)) {
                                log.log(j86.java.util.logging.Level.FINE, "SignatureAlgorithm.register(" + uri + ", "
                                          + javaClass + ")");
                            }
                        } catch (ClassNotFoundException e) {
                            Object exArgs[] = { uri, javaClass };
                ...
                if (tag.equals("ResourceResolvers")) {
                    ...
                    for (int i = 0; i < resolverElem.length; i++) {
                        ...
                        if ((description != null) && (description.length() > 0)) {
                            if (log.isLoggable(j86.java.util.logging.Level.FINE)) {
                                log.log(j86.java.util.logging.Level.FINE, "Register Resolver: " + javaClass + ": "
                                          + description);
                            }
                        } else {
                            if (log.isLoggable(j86.java.util.logging.Level.FINE)) {
                        ...
                        try {
                            ...
                            log.log(j86.java.util.logging.Level.WARNING,
                ...
                if (tag.equals("PrefixMappings")){
                    if (log.isLoggable(j86.java.util.logging.Level.FINE)) {
                        log.log(j86.java.util.logging.Level.FINE, "Now I try to bind prefixes:");
                    }
                    ...
                    for (int i = 0; i < nl.length; i++) {
                        ...
                        if (log.isLoggable(j86.java.util.logging.Level.FINE)) {
                            log.log(j86.java.util.logging.Level.FINE, "Now I try to bind " + prefix + " to " + namespace);
                        }
            ...
            log.log(j86.java.util.logging.Level.SEVERE, "Bad: ", e);
            e.printStackTrace();
        }
    }
