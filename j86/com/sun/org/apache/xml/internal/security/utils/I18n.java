...
public class I18n {
    ...
    public static final String NOT_INITIALIZED_MSG =
        ...
        + "Call the static method \"j86.com.sun.org.apache.xml.internal.security.Init.init();\" to do that "
    ...
    public static String getExceptionMessage(String msgID) {
        try {
            ...
            if (j86.com.sun.org.apache.xml.internal.security.Init.isInitialized()) {
