...
public class X509SubjectNameResolver extends KeyResolverSpi {
    ...
    private static j86.java.util.logging.Logger log =
        j86.java.util.logging.Logger.getLogger(X509SubjectNameResolver.class.getName());
    ...
    public X509Certificate engineLookupResolveX509Certificate(
        ...
        try {
            ...
            while (storageIterator.hasNext()) {
                ...
                if (log.isLoggable(j86.java.util.logging.Level.FINE)) {
                    log.log(j86.java.util.logging.Level.FINE, "Found Certificate SN: " + certSN.getSubjectName());
                }

                for (int i = 0; i < x509childObject.length; i++) {
                    if (log.isLoggable(j86.java.util.logging.Level.FINE)) {
                        log.log(j86.java.util.logging.Level.FINE, "Found Element SN:     "
