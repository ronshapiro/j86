...
public abstract class ElementProxy {
    ...
    protected static final j86.java.util.logging.Logger log =
        j86.java.util.logging.Logger.getLogger(ElementProxy.class.getName());
    ...
    public ElementProxy(Element element, String BaseURI) throws XMLSecurityException {
        ...
        if (log.isLoggable(j86.java.util.logging.Level.FINE)) {
            log.log(j86.java.util.logging.Level.FINE, "setElement(\"" + element.getTagName() + "\", \"" + BaseURI + "\")");
        }
