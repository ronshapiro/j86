...
import j86.com.sun.org.apache.xml.internal.security.keys.content.x509.XMLX509CRL;
...
public class X509Data extends SignatureElementProxy implements KeyInfoContent {
    ...
    private static j86.java.util.logging.Logger log =
        j86.java.util.logging.Logger.getLogger(X509Data.class.getName());
    ...
    public Element itemUnknownElement(int i) {
        if (log.isLoggable(j86.java.util.logging.Level.FINE)) {
            log.log(j86.java.util.logging.Level.FINE, "itemUnknownElement not implemented:" + i);
        }
        return null;
    }
