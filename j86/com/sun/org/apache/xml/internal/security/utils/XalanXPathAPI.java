...
import j86.com.sun.org.apache.xml.internal.security.transforms.implementations.FuncHere;
...
public class XalanXPathAPI implements XPathAPI {
    ...
    private static j86.java.util.logging.Logger log =
        j86.java.util.logging.Logger.getLogger(XalanXPathAPI.class.getName());
    ...
    private synchronized static void fixupFunctionTable() {
        installed = false;
        if (log.isLoggable(j86.java.util.logging.Level.FINE)) {
            log.log(j86.java.util.logging.Level.FINE, "Registering Here function");
        }
        /**
        ...
        try {
            ...
            log.log(j86.java.util.logging.Level.FINE, "Error installing function using the static installFunction method", ex);
        }
        if (!installed) {
            try {
        ...
        if (log.isLoggable(j86.java.util.logging.Level.FINE)) {
            if (installed) {
                log.log(j86.java.util.logging.Level.FINE, "Registered class " + FuncHere.class.getName()
                          + " for XPath function 'here()' function in internal table");
            } else {
                log.log(j86.java.util.logging.Level.FINE, "Unable to register class " + FuncHere.class.getName()
                          + " for XPath function 'here()' function in internal table");
            }
        }
    }
