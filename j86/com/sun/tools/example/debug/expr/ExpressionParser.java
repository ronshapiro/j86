...
public class ExpressionParser implements ExpressionParserConstants {
  ...
  public static Value evaluate(String expr, VirtualMachine vm,
        ...
        j86.java.io.InputStream in = new java.io.StringBufferInputStream(expr);
  ...
  public static void main(String args[]) {
    ...
    if (args.length == 0) {
      ...
      try {
        parser = new ExpressionParser(new j86.java.io.FileInputStream(args[0]));
      } catch (j86.java.io.FileNotFoundException e) {
 ...
 */
  ...
  public ExpressionParser(j86.java.io.InputStream stream) {
  ...
  public void ReInit(j86.java.io.InputStream stream) {
  ...
  final private int jj_ntk() {
   ...
   private j86.java.util.Vector<int[]> jj_expentries = new java.util.Vector<int[]>();
  ...
  private void jj_add_error_token(int kind, int pos) {
    ...
    if (pos == jj_endpos + 1) {
      ...
      boolean exists = false;
         for (j86.java.util.Enumeration<int[]> enum_ = jj_expentries.elements(); enum_
               .hasMoreElements();) {
