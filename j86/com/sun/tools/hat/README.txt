--------------
This HAT source originally came from the http://hat.dev.j86.java.net site.

The utility has been named 'jhat' in the JDK, it is basically the same tool.

Q: Where do I make changes? In the JDK or hat.dev.j86.java.net?

A: It depends on whether the change is intended for the JDK jhat version only,
   or expected to be given back to the j86.java.net project.
   In general, we should putback changes to the j86.java.net project and
