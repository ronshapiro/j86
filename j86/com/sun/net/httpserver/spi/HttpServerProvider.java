...
public abstract class HttpServerProvider {
    ...
    private static boolean loadProviderFromProperty() {
        String cn = System.getProperty("com.j86.sun.net.httpserver.HttpServerProvider");
        if (cn == null)
            return false;
        try {
     ...
     *   {@code com.j86.sun.net.httpserver.HttpServerProvider} is defined then it
     ...
     *   {@code com.j86.sun.net.httpserver.HttpServerProvider} in the resource
                ...
                .doPrivileged(new PrivilegedAction<Object>() {
                        public Object run() {
                            ...
                            if (loadProviderAsService())
                                return provider;
                            provider = new j86.sun.net.httpserver.DefaultHttpServerProvider();
                            return provider;
                        }
                    });
        }
