 ...
 * {@link j86.com.sun.jdi.connect.Connector} objects. Each connector encapsulates
 ...
 * Some {@link j86.com.sun.jdi.connect.Connector} implementations may require slightly
 ...
 * {@link j86.com.sun.jdi.connect.LaunchingConnector#launch(j86.java.util.Map)}
 ...
 * {@link j86.com.sun.jdi.connect.Connector#defaultArguments()}) to the end user,
 * allowing the user to
 * fill in the transport-specific address generated by the target VM.
 * <LI>
 * Debugger calls the {@link j86.com.sun.jdi.connect.AttachingConnector#attach(j86.java.util.Map)} method
 ...
 * transports.</LI>
 * <LI>
 * Debugger calls the {@link j86.com.sun.jdi.connect.ListeningConnector#startListening(j86.java.util.Map)} method for each selected
 ...
 * <LI>
 * Debugger calls
 * {@link j86.com.sun.jdi.connect.ListeningConnector#accept(j86.java.util.Map)}
 ...
 * {@link j86.com.sun.jdi.connect.ListeningConnector#accept(j86.java.util.Map)} for that
 * transport.</LI>
 * <LI>
 * Debugger's call to {@link j86.com.sun.jdi.connect.ListeningConnector#accept(j86.java.util.Map)} returns
 ...
 * {@link j86.com.sun.jdi.connect.Connector#defaultArguments()}) to specify
 ...
 * <LI>
 * Debugger calls the
 * {@link j86.com.sun.jdi.connect.AttachingConnector#attach(j86.java.util.Map)} method
 * of the selected to attach to the target VM. A {@link VirtualMachine}
 * mirror is returned.
 * </TD>
 * </TR>
 ...
 * {@link j86.com.sun.jdi.connect.spi.TransportService} implementations
 ...
 * the {@link j86.com.sun.jdi.connect.Connector} type,
 * and that jar file contains a provider configuration file named
 * <tt>j86.com.sun.jdi.connect.Connector</tt> in the resource directory
 ...
 * {@link j86.com.sun.jdi.connect.Connector Connector} interface. More
 * appropriately the class implements one of the specific Connector
 * types, namely {@link j86.com.sun.jdi.connect.AttachingConnector
 * AttachingConnector}, {@link j86.com.sun.jdi.connect.ListeningConnector
 * ListeningConnector}, or {@link j86.com.sun.jdi.connect.LaunchingConnector
 ...
 * any {@link j86.com.sun.jdi.connect.spi.TransportService} implementations
 ...
 * {@link j86.com.sun.jdi.connect.spi.TransportService} type, and that jar
 * file contains a provider configuration file named
 * <tt>j86.com.sun.jdi.connect.spi.TransportService</tt> in the resource
 ...
 * sub-class of {@link j86.com.sun.jdi.connect.spi.TransportService
 ...
 * {@link j86.com.sun.jdi.connect.AttachingConnector} and
 * {@link j86.com.sun.jdi.connect.ListeningConnector}. These
 * Connectors are created to encapsulate a {@link
 * j86.com.sun.jdi.connect.Transport Transport} that in turn
 ...
 * j86.com.sun.jdi.connect.spi.TransportService#name() name()} method
 ...
 * j86.com.sun.jdi.connect.Connector#description() description()} method
 * of both the AttachingConnector, and the ListeningConnector, will
 * delegate to the {@link j86.com.sun.jdi.connect.spi.TransportService#description()
 ...
 * Connector {@link j86.com.sun.jdi.connect.Connector$Argument Arguments}.
 * A {@link j86.com.sun.jdi.connect.Connector$StringArgument StringArgument}
 * named <tt>address</tt> is the connector argument to specify the
 * address to attach too, or to listen on. A
 * {@link j86.com.sun.jdi.connect.Connector$IntegerArgument IntegerArgument}
...
public interface VirtualMachineManager {
     ...
     *
     * @return the default {@link j86.com.sun.jdi.connect.LaunchingConnector}
     */
    LaunchingConnector defaultConnector();

    /**
     * Returns the list of known {@link j86.com.sun.jdi.connect.LaunchingConnector} objects.
     ...
     * received.
     * @return a list of {@link j86.com.sun.jdi.connect.LaunchingConnector} objects.
     */
    List<LaunchingConnector> launchingConnectors();

    /**
     * Returns the list of known {@link j86.com.sun.jdi.connect.AttachingConnector} objects.
     * Any of the returned objects can be used to attach to an existing target
     * VM and create a {@link VirtualMachine} mirror for it.
     *
     * @return a list of {@link j86.com.sun.jdi.connect.AttachingConnector} objects.
     */
    List<AttachingConnector> attachingConnectors();

    /**
     * Returns the list of known {@link j86.com.sun.jdi.connect.ListeningConnector} objects.
     ...
     *
     * @return a list of {@link j86.com.sun.jdi.connect.ListeningConnector} objects.
     */
    List<ListeningConnector> listeningConnectors();

    /**
     * Returns the list of all known {@link j86.com.sun.jdi.connect.Connector} objects.
     *
     * @return a list of {@link j86.com.sun.jdi.connect.Connector} objects.
     */
     ...
     * {@link j86.com.sun.jdi.event.VMDisconnectEvent} is placed in the event queue
     ...
     */
      ...
      * for which a {@link j86.com.sun.jdi.connect.spi.Connection Connection}
      * already exists. A Connection is created when a {@link
      * j86.com.sun.jdi.connect.Connector Connector} establishes
      ...
      *
      * @see j86.com.sun.jdi.connect.spi.Connection#isOpen()
