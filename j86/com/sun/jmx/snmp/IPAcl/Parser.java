...
jjtree.openNodeScope(jjtn000);Token t;
 ...
 /*@bgen(jjtree) HostInform */
  ...
  public Parser(j86.java.io.InputStream stream) {
  ...
  public Parser(j86.java.io.Reader stream) {
    jj_input_stream = new ASCII_CharStream(stream, 1, 1);
    token_source = new ParserTokenManager(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
  ...
  public void ReInit(j86.java.io.Reader stream) {
    jj_input_stream.ReInit(stream, 1, 1);
    token_source.ReInit(jj_input_stream);
    token = new Token();
    jj_ntk = -1;
  ...
  private j86.java.util.Vector<int[]> jj_expentries = new java.util.Vector<>();
  ...
  private void jj_add_error_token(int kind, int pos) {
    ...
    if (pos == jj_endpos + 1) {
      ...
      for (j86.java.util.Enumeration<int[]> enumv = jj_expentries.elements(); enumv.hasMoreElements();) {
