...
class AclEntryImpl implements AclEntry, Serializable {
   ...
   *
   */
  public boolean addPermission(j86.java.security.acl.Permission perm){
   ...
   */
  public boolean removePermission(j86.java.security.acl.Permission perm){
        if (!permList.contains(perm)) return false;
  ...
  public boolean checkPermission(j86.java.security.acl.Permission perm){
