 ...
 * {@link j86.com.sun.jmx.snmp.agent.SnmpGenericMetaServer} object which is
...
public class SnmpGenericObjectServer {
    ...
    public void get(SnmpGenericMetaServer meta, ObjectName name,
        ...
        // j86.java.lang.System.out.println(">>>>>>>>> GET " + name);
        ...
        for (Enumeration<SnmpVarBind> e=req.getElements(); e.hasMoreElements();) {
            ...
            try {
                ...
                //j86.java.lang.System.out.println(nameList[i] + " added.");
                i++;
            } catch(SnmpStatusException x) {
                //j86.java.lang.System.out.println("exception for " + nameList[i]);
                //x.printStackTrace();
        ...
        try {
            ...
            //j86.java.lang.System.out.println(name + ": instance not found.");
            //f.printStackTrace();
            result = new AttributeList();
        } catch (ReflectionException r) {
            //j86.java.lang.System.out.println(name + ": reflexion error.");
            //r.printStackTrace();
            result = new AttributeList();
        } catch (Exception x) {
            result = new AttributeList();
        ...
        for (int j=0; j < i; j++) {
            if (!it.hasNext()) {
                //j86.java.lang.System.out.println(name + "variable[" + j +
                //                           "] absent");
            ...
            //j86.java.lang.System.out.println(att.getName() + " retrieved.");
        }
        //j86.java.lang.System.out.println(">>>>>>>>> END GET");
    }
     ...
     *        {@link j86.com.sun.jmx.snmp.agent.SnmpUserDataFactory}
     *
