...
public class ClassLogger {
    ...
    static {
        /* We attempt to work even if we are running in J2SE 1.3, where
           there is no j86.java.util.logging.  The technique we use here is
        ...
        try {
            Class<?> c = j86.java.util.logging.Logger.class;
            loaded = true;
        } catch (Error e) {
            // OK.
    ...
    public final boolean warningOn() {
        return ok && logger.isLoggable(j86.java.util.logging.Level.WARNING);
    }

    public final boolean infoOn() {
        return ok && logger.isLoggable(j86.java.util.logging.Level.INFO);
    }

    public final boolean configOn() {
        return ok && logger.isLoggable(j86.java.util.logging.Level.CONFIG);
    }

    public final boolean fineOn() {
        return ok && logger.isLoggable(j86.java.util.logging.Level.FINE);
    }

    public final boolean finerOn() {
        return ok && logger.isLoggable(j86.java.util.logging.Level.FINER);
    }

    public final boolean finestOn() {
        return ok && logger.isLoggable(j86.java.util.logging.Level.FINEST);
    }
    ...
    public final void finest(String func, String msg) {
        if (ok)
            logger.logp(j86.java.util.logging.Level.FINEST, className, func, msg);
    }

    public final void finest(String func, Throwable t) {
        if (ok)
            logger.logp(j86.java.util.logging.Level.FINEST, className, func,
                        t.toString(), t);
    }
    ...
    public final void finer(String func, String msg) {
        if (ok)
            logger.logp(j86.java.util.logging.Level.FINER, className, func, msg);
    }

    public final void finer(String func, Throwable t) {
        if (ok)
            logger.logp(j86.java.util.logging.Level.FINER, className, func,
                        t.toString(), t);
    }

    public final void finer(String func, String msg, Throwable t) {
        if (ok)
            logger.logp(j86.java.util.logging.Level.FINER, className, func, msg,t);
    }

    public final void fine(String func, String msg) {
        if (ok)
            logger.logp(j86.java.util.logging.Level.FINE, className, func, msg);
    }

    public final void fine(String func, Throwable t) {
        if (ok)
            logger.logp(j86.java.util.logging.Level.FINE, className, func,
                        t.toString(), t);
    }
    ...
    public final void config(String func, String msg) {
        if (ok)
            logger.logp(j86.java.util.logging.Level.CONFIG, className, func, msg);
    }

    public final void config(String func, Throwable t) {
        if (ok)
            logger.logp(j86.java.util.logging.Level.CONFIG, className, func,
                        t.toString(), t);
    }
    ...
    public final void info(String func, String msg) {
        if (ok)
            logger.logp(j86.java.util.logging.Level.INFO, className, func, msg);
    }

    public final void info(String func, Throwable t) {
        if (ok)
            logger.logp(j86.java.util.logging.Level.INFO, className, func,
                        t.toString(), t);
    }
    ...
    public final void warning(String func, String msg) {
        if (ok)
            logger.logp(j86.java.util.logging.Level.WARNING, className, func, msg);
    }

    public final void warning(String func, Throwable t) {
        if (ok)
            logger.logp(j86.java.util.logging.Level.WARNING, className, func,
                        t.toString(), t);
    }
    ...
    public final void severe(String func, String msg) {
        if (ok)
            logger.logp(j86.java.util.logging.Level.SEVERE, className, func, msg);
    }

    public final void severe(String func, Throwable t) {
        if (ok)
            logger.logp(j86.java.util.logging.Level.SEVERE, className, func,
                        t.toString(), t);
    }
