...
import j86.javax.management.MBeanServerBuilder;

/**
 * This class represents a builder that creates
 * {@link j86.javax.management.MBeanServer} implementations.
 ...
 * <p>
 * Contrarily to the default {@link j86.javax.management.MBeanServerBuilder
 * j86.javax.management.MBeanServerBuilder} this MBeanServerBuilder returns
 * MBeanServers on which
 * {@link j86.com.sun.jmx.interceptor.MBeanServerInterceptor}s are enabled.
 *
 * @since 1.5
 */
public class JmxMBeanServerBuilder extends MBeanServerBuilder {
     ...
     * which support {@link j86.com.sun.jmx.interceptor.MBeanServerInterceptor}s.
     *
